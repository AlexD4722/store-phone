                    ...
                    <div className='blog-posts'>
                        <div className='blog-posts__comp'>
                            ...
                            <div className='blog-posts__main'>
                                ...
                                <Link>
                                    <button type="button" className='blog-posts__btn-learn-more'>
                                        <span className='blog-posts__btn-content'>read more</span>
                                    </button>
                                </Link>
                            </div>
                        </div>
                                ...
                                <ul className='sidebar-blog__list-post'>
                                        ...
                                        <Link to="">
                                            <div className='sidebar-blog__img-post-wrapper'>
                                                <div className='sidebar-blog__img-post'>
                                                    <img src={post01} alt="smartwatch" />
                                                </div>
                                            </div>
                                            <div className='sidebar-blog__content-post'>
                                                <h5 className='sidebar-blog__title-post'>WATCHES</h5>
                                    ...
                                    <li>
                                        <Link to="">
                                            <div className='sidebar-blog__img-post-wrapper'>
                                                <div className='sidebar-blog__img-post'>
                                                    <img src={post02} alt="CAMERA" />
                                                </div>
                                            </div>
                                            <div className='sidebar-blog__content-post'>
                                                <h5 className='sidebar-blog__title-post'>CAMERA</h5>
                                                <div className='sidebar-blog__description'>
                                    ...
                                    <li>
                                        <Link to="">
                                            <div className='sidebar-blog__img-post-wrapper'>
                                                <div className='sidebar-blog__img-post'>
                                                    <img src={post03} alt="TABLET" />
                                                </div>
                                            </div>
                                            <div className='sidebar-blog__content-post'>
                                                <h5 className='sidebar-blog__title-post'>TABLET</h5>
                                                <div className='sidebar-blog__description'>
