...
$product = new Product($data->name, json_encode($data->description), $data->initalPrice, $data->sellingPrice, $data->quantity, $data->images, json_encode($data->color), json_encode($data->capacity), 1);
